...
function EventDetailModalComponent_div_0_div_7_div_44_button_4_span_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", ticket_r5.availableQuantity, " left");
  }
}
function EventDetailModalComponent_div_0_div_7_div_44_button_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, EventDetailModalComponent_div_0_div_7_div_44_button_4_span_10_Template, 2, 1, "span", 54);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ticket_r5 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(9, _c2, ctx_r1.selectedTicketTypeId === ticket_r5.id, ctx_r1.selectedTicketTypeId !== ticket_r5.id));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ticket_r5.name || ticket_r5.type);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(12, _c3, ctx_r1.getTicketStatus(ticket_r5) === "Available", ctx_r1.getTicketStatus(ticket_r5) === "Few left", ctx_r1.getTicketStatus(ticket_r5) === "Sold out" || ctx_r1.getTicketStatus(ticket_r5) === "Closed", ctx_r1.getTicketStatus(ticket_r5) === "Not eligible"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getTicketStatus(ticket_r5), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ticket_r5.price === 0 ? "Free" : "\u20B9" + \u0275\u0275pipeBind2(9, 6, ticket_r5.price, "1.0-0"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ticket_r5.availableQuantity != null);
  }
}
...
function EventDetailModalComponent_div_0_div_7_div_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, EventDetailModalComponent_div_0_div_7_div_44_button_4_Template, 11, 17, "button", 46);
    \u0275\u0275elementEnd();
...
function EventDetailModalComponent_div_0_div_7_div_66_div_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", (s_r6.name || "S")[0], " ");
    \u0275\u0275advance(3);
...
function EventDetailModalComponent_div_0_div_7_div_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "span", 57);
    \u0275\u0275text(2, "Voice & Authority");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 58);
    \u0275\u0275template(4, EventDetailModalComponent_div_0_div_7_div_66_div_4_Template, 8, 3, "div", 59);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function EventDetailModalComponent_div_0_div_7_div_67_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 67)(4, "p", 62);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatScheduleTime(item_r7.startTime), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r7.title || "Session");
    \u0275\u0275advance(2);
...
function EventDetailModalComponent_div_0_div_7_div_67_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 58);
    \u0275\u0275template(4, EventDetailModalComponent_div_0_div_7_div_67_div_4_Template, 8, 3, "div", 64);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function EventDetailModalComponent_div_0_div_7_div_68_div_6_div_2_tr_15_button_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function EventDetailModalComponent_div_0_div_7_div_68_div_6_div_2_tr_15_button_12_Template_button_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r1.markAttendance(a_r10));
    });
    \u0275\u0275text(1, "AUTHORIZE");
    \u0275\u0275elementEnd();
  }
...
function EventDetailModalComponent_div_0_div_7_div_68_div_6_div_2_tr_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td", 83)(6, "span", 84);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "td")(9, "span", 85);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "td", 79);
    \u0275\u0275template(12, EventDetailModalComponent_div_0_div_7_div_68_div_6_div_2_tr_15_button_12_Template, 2, 0, "button", 86);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const a_r10 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(a_r10.userEmail);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(a_r10.ticketTypeName);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", a_r10.status === "CONFIRMED" ? "bg-emerald-50 text-emerald-600" : "bg-slate-100 text-slate-400");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(a_r10.status);
    \u0275\u0275advance(2);
    \u0275\u0275classMap(a_r10.checkedIn ? "text-indigo-600" : "text-slate-300");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(a_r10.checkedIn ? "SECURED" : "PENDING");
    \u0275\u0275advance(2);
...
function EventDetailModalComponent_div_0_div_7_div_68_div_6_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 78)(1, "table")(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Identity");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "Ticket");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "th", 79);
    \u0275\u0275text(13, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "tbody");
    \u0275\u0275template(15, EventDetailModalComponent_div_0_div_7_div_68_div_6_div_2_tr_15_Template, 13, 8, "tr", 80);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function EventDetailModalComponent_div_0_div_7_div_68_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, EventDetailModalComponent_div_0_div_7_div_68_div_6_div_1_Template, 2, 0, "div", 75)(2, EventDetailModalComponent_div_0_div_7_div_68_div_6_div_2_Template, 16, 1, "div", 76);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(4);
...
function EventDetailModalComponent_div_0_div_7_div_68_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, EventDetailModalComponent_div_0_div_7_div_68_div_6_Template, 3, 2, "div", 73);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function EventDetailModalComponent_div_0_div_7_button_70_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("disabled", ctx_r1.isRegistering || ctx_r1.isUserRegistered() || !ctx_r1.canProceedRegistration());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getRegisterButtonText(), " ");
  }
}
...
var EventDetailModalComponent = class _EventDetailModalComponent {
  ...
  getTicketTypes() {
    ...
    const normalized = list.filter((t) => t && t.id != null).map((t) => __spreadProps(__spreadValues({}, t), {
...
//# sourceMappingURL=chunk-TU4ZYDAB.js.map
