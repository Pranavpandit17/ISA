...
function MemberManagementComponent_div_18_div_6_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(17, "Active Member");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "td", 26)(19, "button", 36);
    \u0275\u0275listener("click", function MemberManagementComponent_div_18_div_6_tr_19_Template_button_click_19_listener() {
      const member_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.openDetailModal(member_r6));
    });
    \u0275\u0275text(20, "Full Overview");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r0.getMemberPlanName(member_r6), " ");
    \u0275\u0275advance(2);
...
function MemberManagementComponent_div_18_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "th");
    \u0275\u0275text(13, "Specialization");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "th");
    \u0275\u0275text(15, "Account Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 26);
    \u0275\u0275text(17, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "tbody", 27);
    \u0275\u0275template(19, MemberManagementComponent_div_18_div_6_tr_19_Template, 21, 7, "tr", 28);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MemberManagementComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, MemberManagementComponent_div_18_div_4_Template, 4, 0, "div", 14)(5, MemberManagementComponent_div_18_div_5_Template, 5, 0, "div", 15)(6, MemberManagementComponent_div_18_div_6_Template, 20, 1, "div", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function MemberManagementComponent_div_19_div_6_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tr", 42)(1, "td", 30);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function MemberManagementComponent_div_19_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "tbody", 27);
    \u0275\u0275template(17, MemberManagementComponent_div_19_div_6_tr_17_Template, 15, 5, "tr", 41);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
var MemberManagementComponent = class _MemberManagementComponent {
  ...
  getMemberPlanName(member) {
    if (!member)
      return "No Plan";
    return member.activePlanName || member.currentPlanName || member.planName || member.selectedPlanName || "No Plan";
  }
  static {
...
//# sourceMappingURL=chunk-J6KDRKHB.js.map
