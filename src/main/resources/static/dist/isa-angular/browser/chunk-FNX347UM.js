...
function EventDetailModalComponent_div_0_div_7_div_44_button_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(10, _c2, ctx_r1.selectedTicketTypeId === ticket_r5.id, ctx_r1.selectedTicketTypeId !== ticket_r5.id));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ticket_r5.name || ticket_r5.type);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(13, _c3, ctx_r1.getTicketStatus(ticket_r5) === "Available", ctx_r1.getTicketStatus(ticket_r5) === "Few left", ctx_r1.getTicketStatus(ticket_r5) === "Sold out" || ctx_r1.getTicketStatus(ticket_r5) === "Closed", ctx_r1.getTicketStatus(ticket_r5) === "Not eligible"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getTicketStatus(ticket_r5), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ticket_r5.price === 0 ? "Free" : "\u20B9" + \u0275\u0275pipeBind2(11, 7, ticket_r5.price, "1.0-0"));
    \u0275\u0275advance(2);
