...
function HomeComponent_div_104_div_1_span_7_Template(rf, ctx) {
  if (rf & 1) {
...
function HomeComponent_div_104_div_1_div_21_p_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const feature_r17 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", feature_r17.description, " ");
  }
}
function HomeComponent_div_104_div_1_div_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 86)(1, "div", 159);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 160);
    \u0275\u0275element(3, "path", 161);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(4, "div")(5, "h5", 162);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, HomeComponent_div_104_div_1_div_21_p_7_Template, 2, 1, "p", 163);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const plan_r16 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", plan_r16.highlight ? "bg-blue-500/20 text-blue-400" : "bg-white/5 text-slate-400");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(feature_r17.name);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", feature_r17.description);
  }
}
function HomeComponent_div_104_div_1_div_22_Template(rf, ctx) {
  if (rf & 1) {
...
function HomeComponent_div_104_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "div", 137);
    \u0275\u0275elementStart(2, "div", 138)(3, "div", 139)(4, "div", 140)(5, "span", 141);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, HomeComponent_div_104_div_1_span_7_Template, 2, 0, "span", 142);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 143);
    \u0275\u0275template(9, HomeComponent_div_104_div_1_h3_9_Template, 2, 0, "h3", 144)(10, HomeComponent_div_104_div_1_h3_10_Template, 2, 0, "h3", 144)(11, HomeComponent_div_104_div_1_div_11_Template, 5, 2, "div", 145);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "p", 146);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 147)(15, "button", 148);
    \u0275\u0275listener("click", function HomeComponent_div_104_div_1_Template_button_click_15_listener() {
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 149)(18, "h4", 150);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 151);
    \u0275\u0275template(21, HomeComponent_div_104_div_1_div_21_Template, 8, 3, "div", 152)(22, HomeComponent_div_104_div_1_div_22_Template, 2, 0, "div", 153);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275classProp("featured-card", plan_r16.highlight);
    \u0275\u0275advance();
    \u0275\u0275classProp("opacity-100", plan_r16.highlight);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", plan_r16.highlight ? "text-blue-400" : "text-slate-400");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", plan_r16.name, " ");
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", plan_r16.period || "Access to base core features.", " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", plan_r16.highlight ? "bg-blue-600 hover:bg-blue-500 text-white shadow-[0_0_20px_rgba(37,99,235,0.4)]" : "bg-white/5 hover:bg-white/10 text-white border border-white/10");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", plan_r16.btnText || (plan_r16.price > 0 ? "Upgrade Now" : "Start Free"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("What's included in ", plan_r16.name, "");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r7.getPlanFeatureObjects(plan_r16));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r7.getPlanFeatureObjects(plan_r16).length === 0);
  }
}
function HomeComponent_div_104_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 134);
    \u0275\u0275template(1, HomeComponent_div_104_div_1_Template, 23, 18, "div", 135);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r7 = \u0275\u0275nextContext();
...
function HomeComponent_div_134_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "img", 168);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h4", 169);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p", 170);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 171);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function HomeComponent_div_143_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 172)(1, "button", 173);
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, HomeComponent_div_143_div_6_Template, 2, 1, "div", 175);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
//# sourceMappingURL=chunk-QCCE5LFC.js.map
