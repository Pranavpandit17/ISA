...
var EventsComponent = class _EventsComponent {
  constructor(dataService, authService, apiService, membershipService, modalService) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventsComponent, { className: "EventsComponent", filePath: "src\\app\\pages\\events\\events.component.ts", lineNumber: 18 });
})();
export {
  EventsComponent
};
//# sourceMappingURL=chunk-DLMX2VLR.js.map
