...
} from "./chunk-VV64SB4P.js";
import {
  EventManagementComponent
} from "./chunk-KVWZ5C3P.js";
import {
  ConfirmService
} from "./chunk-ZFJR45MD.js";
import {
  MemberManagementComponent
} from "./chunk-PHNBJM47.js";
import {
  ToastrService
...
function MembershipPlanManagementComponent_button_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("disabled", ctx_r1.showForm || ctx_r1.isLoading);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.showForm ? "Form Active" : "Create New Plan", " ");
  }
}
function MembershipPlanManagementComponent_div_33_Template(rf, ctx) {
  if (rf & 1) {
...
function MembershipPlanManagementComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
...
function MembershipPlanManagementComponent_div_35_div_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "label", 29);
    \u0275\u0275text(2, "Financial Value");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 51);
    \u0275\u0275twoWayListener("ngModelChange", function MembershipPlanManagementComponent_div_35_div_33_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r4);
...
function MembershipPlanManagementComponent_div_35_div_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function MembershipPlanManagementComponent_div_35_div_34_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function MembershipPlanManagementComponent_div_35_div_41_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
function MembershipPlanManagementComponent_div_35_div_41_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 53);
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_35_div_41_Template_div_click_0_listener() {
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(9, MembershipPlanManagementComponent_div_35_div_41_div_9_Template, 2, 0, "div", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function MembershipPlanManagementComponent_div_35_div_42_Template(rf, ctx) {
  if (rf & 1) {
...
function MembershipPlanManagementComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 25)(1, "div", 26)(2, "h2");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 27);
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_35_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(5, "\xD7");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 28)(7, "div")(8, "label", 29);
    \u0275\u0275text(9, "Identity Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "input", 30);
    \u0275\u0275twoWayListener("ngModelChange", function MembershipPlanManagementComponent_div_35_Template_input_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "select", 31);
    \u0275\u0275twoWayListener("ngModelChange", function MembershipPlanManagementComponent_div_35_Template_select_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.form.type, $event) || (ctx_r1.form.type = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(15, "option", 32);
    \u0275\u0275text(16, "INDIVIDUAL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "option", 33);
    \u0275\u0275text(18, "CORPORATE");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "option", 34);
    \u0275\u0275text(20, "ANNUAL");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "div")(22, "label", 29);
    \u0275\u0275text(23, "Access Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "select", 31);
    \u0275\u0275twoWayListener("ngModelChange", function MembershipPlanManagementComponent_div_35_Template_select_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(29, "div")(30, "label", 29);
    \u0275\u0275text(31, "Duration Lifecycle (Months)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "input", 37);
    \u0275\u0275twoWayListener("ngModelChange", function MembershipPlanManagementComponent_div_35_Template_input_ngModelChange_32_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(33, MembershipPlanManagementComponent_div_35_div_33_Template, 4, 2, "div", 38)(34, MembershipPlanManagementComponent_div_35_div_34_Template, 4, 2, "div", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div", 39)(36, "label", 40);
    \u0275\u0275text(37, " Integrated Features Archive ");
    \u0275\u0275elementStart(38, "span", 41);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div", 42);
    \u0275\u0275template(41, MembershipPlanManagementComponent_div_35_div_41_Template, 10, 6, "div", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275template(42, MembershipPlanManagementComponent_div_35_div_42_Template, 3, 0, "div", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "div", 45)(44, "label", 29);
    \u0275\u0275text(45, "Initial Availability");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "div", 46)(47, "button", 47);
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_35_Template_button_click_47_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_35_Template_button_click_49_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(50, "INACTIVE");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(51, "div", 48)(52, "button", 49);
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_35_Template_button_click_52_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.cancelEdit());
    });
    \u0275\u0275text(53, "DISCARD");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "button", 50);
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_35_Template_button_click_54_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function MembershipPlanManagementComponent_div_37_Template(rf, ctx) {
  if (rf & 1) {
...
function MembershipPlanManagementComponent_div_38_Template(rf, ctx) {
  if (rf & 1) {
...
function MembershipPlanManagementComponent_div_39_tr_19_span_7_Template(rf, ctx) {
  if (rf & 1) {
...
function MembershipPlanManagementComponent_div_39_tr_19_span_8_Template(rf, ctx) {
  if (rf & 1) {
...
function MembershipPlanManagementComponent_div_39_tr_19_div_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 89)(1, "button", 90);
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_39_tr_19_div_22_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const plan_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_39_tr_19_div_22_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r9);
      const plan_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function MembershipPlanManagementComponent_div_39_tr_19_div_22_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r9);
      const plan_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function MembershipPlanManagementComponent_div_39_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 74)(1, "td", 75);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td")(4, "span", 76);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td", 77);
    \u0275\u0275template(7, MembershipPlanManagementComponent_div_39_tr_19_span_7_Template, 3, 5, "span", 78)(8, MembershipPlanManagementComponent_div_39_tr_19_span_8_Template, 2, 0, "span", 79);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td", 80);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td")(12, "div", 81);
    \u0275\u0275element(13, "div", 82);
    ...
    \u0275\u0275text(17, "Members");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "td")(19, "span", 85);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "td", 71);
    \u0275\u0275template(22, MembershipPlanManagementComponent_div_39_tr_19_div_22_Template, 7, 1, "div", 86);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function MembershipPlanManagementComponent_div_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 68)(1, "table", 69)(2, "thead", 70)(3, "tr")(4, "th");
    ...
    \u0275\u0275text(17, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "tbody", 72);
    \u0275\u0275template(19, MembershipPlanManagementComponent_div_39_tr_19_Template, 23, 10, "tr", 73);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MembershipPlanManagementComponent, selectors: [["app-membership-plan-management"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 40, vars: 10, consts: [[1, "management-container"], [1, "mb-10", "flex", "flex-col", "md:flex-row", "md:items-end", "justify-between", "gap-6"], [1, "title-area"], [1, "text-4xl", "font-black", "text-slate-900", "mb-2", "tracking-tighter"], [1, "text-sm", "font-medium", "text-slate-400"], ["class", "btn-premium flex items-center gap-2", 3, "disabled", "click", 4, "ngIf"], [1, "stats-grid"], [1, "stat-card"], [1, "stat-info"], [1, "stat-icon", "bg-indigo-50", "text-indigo-600"], [1, "text-emerald-500"], [1, "stat-icon", "bg-emerald-50", "text-emerald-600"], [1, "stat-card", "border-slate-100", "opacity-60"], [1, "stat-icon", "bg-slate-50", "text-slate-400"], ["class", "mb-8 p-4 bg-emerald-50 border-l-4 border-emerald-500 text-emerald-700 rounded-r-2xl text-sm font-medium animate-pulse", 4, "ngIf"], ["class", "mb-8 p-4 bg-rose-50 border-l-4 border-rose-500 text-rose-700 rounded-r-2xl text-sm font-medium animate-pulse", 4, "ngIf"], ["class", "form-panel", "id", "plan-form", 4, "ngIf"], [1, "table-wrapper"], ["class", "p-40 text-center flex flex-col items-center justify-center gap-4", 4, "ngIf"], ["class", "p-40 text-center", 4, "ngIf"], ["class", "overflow-x-auto", 4, "ngIf"], [1, "btn-premium", "flex", "items-center", "gap-2", 3, "click", "disabled"], [1, "text-xl"], [1, "mb-8", "p-4", "bg-emerald-50", "border-l-4", "border-emerald-500", "text-emerald-700", "rounded-r-2xl", "text-sm", "font-medium", "animate-pulse"], [1, "mb-8", "p-4", "bg-rose-50", "border-l-4", "border-rose-500", "text-rose-700", "rounded-r-2xl", "text-sm", "font-medium", "animate-pulse"], ["id", "plan-form", 1, "form-panel"], [1, "form-header"], [1, "text-slate-300", "hover:text-slate-600", "font-black", "text-2xl", "transition-all", 3, "click"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-8", "mb-8"], [1, "input-label"], ["type", "text", "placeholder", "e.g. Executive Platinum", 1, "form-input", 3, "ngModelChange", "ngModel", "disabled"], [1, "form-input", 3, "ngModelChange", "ngModel", "disabled"], ["value", "INDIVIDUAL"], ["value", "CORPORATE"], ["value", "ANNUAL"], ["value", "FREE"], ["value", "PAID"], ["type", "number", "placeholder", "12", 1, "form-input", 3, "ngModelChange", "ngModel", "disabled"], [4, "ngIf"], [1, "mb-8", "p-6", "bg-slate-50/50", "rounded-3xl", "border", "border-slate-100"], [1, "input-label", "font-black", "mb-4", "flex", "items-center", "gap-2"], [1, "bg-indigo-600", "text-white", "px-2", "py-0.5", "rounded-full", "text-[10px]"], [1, "feature-list-container", "gap-4"], ["class", "feature-item", 3, "selected", "click", 4, "ngFor", "ngForOf"], ["class", "p-10 text-center", 4, "ngIf"], [1, "mb-10"], [1, "flex", "gap-4"], [1, "px-6", "py-2", "rounded-xl", "text-xs", "font-bold", "transition-all", 3, "click"], [1, "flex", "justify-end", "gap-3", "pt-6", "border-t", "border-slate-100"], [1, "px-8", "py-3", "rounded-2xl", "border-2", "border-slate-100", "text-slate-400", "font-black", "text-xs", "hover:bg-slate-50", "transition-all", 3, "click", "disabled"], [1, "btn-premium", "px-10", "py-3", 3, "click", "disabled"], ["type", "number", "placeholder", "0.00", 1, "form-input", 3, "ngModelChange", "ngModel", "disabled"], ["type", "text", "maxlength", "3", "placeholder", "INR", 1, "form-input", 3, "ngModelChange", "ngModel", "disabled"], [1, "feature-item", 3, "click"], [1, "flex-1"], [1, "flex", "items-center", "gap-2", "mb-1"], [1, "text-[10px]", "font-black", "uppercase", "text-indigo-400", "font-mono"], [1, "text-sm", "font-bold", "text-slate-800"], [1, "text-[11px]", "text-slate-400", "line-clamp-1", "italic", "font-medium"], ["class", "text-indigo-600 text-xl font-black", 4, "ngIf"], [1, "text-indigo-600", "text-xl", "font-black"], [1, "p-10", "text-center"], [1, "text-sm", "font-bold", "text-slate-400"], [1, "p-40", "text-center", "flex", "flex-col", "items-center", "justify-center", "gap-4"], [1, "h-10", "w-10", "border-4", "border-indigo-100", "border-t-indigo-600", "rounded-full", "animate-spin"], [1, "text-xs", "font-black", "text-slate-300", "uppercase", "tracking-widest"], [1, "p-40", "text-center"], [1, "text-6xl", "mb-4", "grayscale", "opacity-20"], [1, "overflow-x-auto"], [1, "w-full"], [1, "text-left", "font-bold", "uppercase", "text-[10px]", "tracking-widest", "text-slate-400"], [1, "text-right"], [1, "divide-y", "divide-slate-50"], ["class", "hover:bg-slate-50/50 transition-colors", 4, "ngFor", "ngForOf"], [1, "hover:bg-slate-50/50", "transition-colors"], [1, "font-black", "text-slate-900"], [1, "text-[10px]", "font-black", "px-3", "py-1", "bg-indigo-50", "text-indigo-600", "rounded-lg"], [1, "text-sm", "font-black"], ["class", "text-indigo-600", 4, "ngIf"], ["class", "text-slate-400 font-bold opacity-50 uppercase tracking-tighter", 4, "ngIf"], [1, "text-sm", "font-medium", "text-slate-500"], [1, "flex", "items-center", "gap-2"], [1, "w-2", "h-2", "rounded-full", "bg-slate-200"], [1, "text-sm", "font-black", "text-slate-900"], [1, "text-[10px]", "uppercase", "font-black", "text-slate-400"], [1, "badge", 3, "ngClass"], ["class", "flex items-center justify-end gap-2", 4, "ngIf"], [1, "text-indigo-600"], [1, "text-slate-400", "font-bold", "opacity-50", "uppercase", "tracking-tighter"], [1, "flex", "items-center", "justify-end", "gap-2"], [1, "text-xs", "font-black", "text-indigo-600", "hover:bg-indigo-50", "px-3", "py-1.5", "rounded-lg", "transition-all", 3, "click"], [1, "text-xs", "font-black", "text-slate-400", "hover:text-slate-900", "px-3", "py-1.5", "rounded-lg", "transition-all", 3, "click"], [1, "text-xs", "font-black", "text-rose-500", "hover:bg-rose-50", "px-3", "py-1.5", "rounded-lg", "transition-all", 3, "click"]], template: function MembershipPlanManagementComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(8, "div", 6)(9, "div", 7)(10, "div", 8)(11, "p");
        \u0275\u0275text(12, "Total Inventory");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(16, "\u{1F3DB}\uFE0F");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "div", 7)(18, "div", 8)(19, "p");
        \u0275\u0275text(20, "Active Offerings");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(21, "h3", 10);
        \u0275\u0275text(22);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(23, "div", 11);
        \u0275\u0275text(24, "\u{1F4E1}");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(25, "div", 12)(26, "div", 8)(27, "p");
        \u0275\u0275text(28, "Archived Plans");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(32, "\u{1F4C1}");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(33, MembershipPlanManagementComponent_div_33_Template, 2, 1, "div", 14)(34, MembershipPlanManagementComponent_div_34_Template, 2, 1, "div", 15)(35, MembershipPlanManagementComponent_div_35_Template, 56, 21, "div", 16);
        \u0275\u0275elementStart(36, "div", 17);
        \u0275\u0275template(37, MembershipPlanManagementComponent_div_37_Template, 4, 0, "div", 18)(38, MembershipPlanManagementComponent_div_38_Template, 5, 0, "div", 19)(39, MembershipPlanManagementComponent_div_39_Template, 20, 1, "div", 20);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
...
function PlanFeatureManagementComponent_button_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("disabled", ctx_r1.showForm || ctx_r1.isLoading);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.showForm ? "Form Active" : "Define New Feature", " ");
  }
}
function PlanFeatureManagementComponent_div_33_Template(rf, ctx) {
  if (rf & 1) {
...
function PlanFeatureManagementComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
...
function PlanFeatureManagementComponent_div_35_p_11_Template(rf, ctx) {
  if (rf & 1) {
...
function PlanFeatureManagementComponent_div_35_p_12_Template(rf, ctx) {
  if (rf & 1) {
...
function PlanFeatureManagementComponent_div_35_option_25_Template(rf, ctx) {
  if (rf & 1) {
...
function PlanFeatureManagementComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 30)(1, "div", 31)(2, "h2", 32);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 33);
    \u0275\u0275listener("click", function PlanFeatureManagementComponent_div_35_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.cancelEdit());
    });
    \u0275\u0275text(5, "\xD7");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 34)(7, "div", 35)(8, "label");
    \u0275\u0275text(9, "System Code Keyword");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "input", 36);
    \u0275\u0275twoWayListener("ngModelChange", function PlanFeatureManagementComponent_div_35_Template_input_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.form.code, $event) || (ctx_r1.form.code = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function PlanFeatureManagementComponent_div_35_Template_input_input_10_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onCodeInput($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, PlanFeatureManagementComponent_div_35_p_11_Template, 2, 0, "p", 37)(12, PlanFeatureManagementComponent_div_35_p_12_Template, 2, 0, "p", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 35)(14, "label");
    \u0275\u0275text(15, "Public Facing Title");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "input", 39);
    \u0275\u0275twoWayListener("ngModelChange", function PlanFeatureManagementComponent_div_35_Template_input_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.form.name, $event) || (ctx_r1.form.name = $event);
      return \u0275\u0275resetView($event);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 40)(18, "label", 41);
    \u0275\u0275text(19, "Description & Narrative");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "textarea", 42);
    \u0275\u0275twoWayListener("ngModelChange", function PlanFeatureManagementComponent_div_35_Template_textarea_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "select", 43);
    \u0275\u0275twoWayListener("ngModelChange", function PlanFeatureManagementComponent_div_35_Template_select_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.form.category, $event) || (ctx_r1.form.category = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275template(25, PlanFeatureManagementComponent_div_35_option_25_Template, 2, 2, "option", 44);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 35)(27, "label");
    \u0275\u0275text(28, "Initial Lifecycle Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "select", 43);
    \u0275\u0275twoWayListener("ngModelChange", function PlanFeatureManagementComponent_div_35_Template_select_ngModelChange_29_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "option", 45);
    \u0275\u0275text(33, "Internal/Suspended");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(34, "div", 46)(35, "button", 47);
    \u0275\u0275listener("click", function PlanFeatureManagementComponent_div_35_Template_button_click_35_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.cancelEdit());
    });
    ...
    \u0275\u0275listener("click", function PlanFeatureManagementComponent_div_35_Template_button_click_37_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function PlanFeatureManagementComponent_button_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function PlanFeatureManagementComponent_button_39_Template_button_click_0_listener() {
      const cat_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onTabChange(cat_r6));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("active", ctx_r1.activeTab === cat_r6);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(cat_r6);
  }
}
function PlanFeatureManagementComponent_div_41_Template(rf, ctx) {
  if (rf & 1) {
...
function PlanFeatureManagementComponent_div_42_Template(rf, ctx) {
  if (rf & 1) {
...
function PlanFeatureManagementComponent_div_43_th_16_Template(rf, ctx) {
  if (rf & 1) {
...
function PlanFeatureManagementComponent_div_43_tr_18_td_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 64)(1, "div", 75)(2, "button", 76);
    \u0275\u0275listener("click", function PlanFeatureManagementComponent_div_43_tr_18_td_24_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r7);
      const feature_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.startEdit(feature_r8));
    });
    \u0275\u0275text(3, "Modify");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 77);
    \u0275\u0275listener("click", function PlanFeatureManagementComponent_div_43_tr_18_td_24_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r7);
      const feature_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteFeature(feature_r8));
    });
    \u0275\u0275text(5, "Erase");
    \u0275\u0275elementEnd()()();
  }
}
function PlanFeatureManagementComponent_div_43_tr_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 65)(1, "td")(2, "code", 66);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td")(5, "p", 67);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 68);
    \u0275\u0275text(8, "Resource Managed");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td")(10, "p", 69);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "td")(13, "span", 70);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "td")(16, "span", 71);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "td")(19, "div", 72)(20, "span", 73);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "span", 74);
    \u0275\u0275text(23, "Linked Plans");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(24, PlanFeatureManagementComponent_div_43_tr_18_td_24_Template, 6, 0, "td", 61);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r8.code);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r8.name);
    \u0275\u0275advance(4);
    \u0275\u0275property("title", feature_r8.description);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(feature_r8.description || "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r8.category);
    \u0275\u0275advance(2);
    \u0275\u0275classMap(feature_r8.isActive ? "text-emerald-500" : "text-slate-400 opacity-50");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(feature_r8.isActive ? "Active" : "Suspended");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate((feature_r8.planIds == null ? null : feature_r8.planIds.length) || 0);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.isAdmin);
  }
}
function PlanFeatureManagementComponent_div_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "table", 59)(2, "thead", 60)(3, "tr")(4, "th");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, PlanFeatureManagementComponent_div_43_th_16_Template, 2, 0, "th", 61);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "tbody", 62);
    \u0275\u0275template(18, PlanFeatureManagementComponent_div_43_tr_18_Template, 25, 10, "tr", 63);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlanFeatureManagementComponent, selectors: [["app-plan-feature-management"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 44, vars: 13, consts: [[1, "management-container"], [1, "mb-10", "flex", "flex-col", "md:flex-row", "md:items-end", "justify-between", "gap-6"], [1, "title-area"], [1, "text-4xl", "font-black", "text-slate-900", "mb-2", "tracking-tighter"], [1, "text-sm", "font-medium", "text-slate-400"], ["class", "btn-premium flex items-center gap-2", 3, "disabled", "click", 4, "ngIf"], [1, "stats-grid"], [1, "stat-card"], [1, "stat-info"], [1, "text-slate-900", "font-black"], [1, "stat-icon", "bg-indigo-50", "text-indigo-600"], [1, "text-emerald-500", "font-black"], [1, "stat-icon", "bg-emerald-50", "text-emerald-600"], [1, "stat-card", "border-slate-100", "opacity-60"], [1, "text-slate-400", "font-black"], [1, "stat-icon", "bg-slate-50", "text-slate-400"], ["class", "mb-8 p-4 bg-emerald-50 border-l-4 border-emerald-500 text-emerald-700 rounded-r-2xl text-sm font-medium animate-pulse", 4, "ngIf"], ["class", "mb-8 p-4 bg-rose-50 border-l-4 border-rose-500 text-rose-700 rounded-r-2xl text-sm font-medium animate-pulse", 4, "ngIf"], ["class", "form-card", "id", "feature-form", 4, "ngIf"], [1, "cat-nav"], [1, "cat-btn", 3, "click"], ["class", "cat-btn", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "table-wrapper"], ["class", "p-40 text-center flex flex-col items-center justify-center gap-4", 4, "ngIf"], ["class", "p-40 text-center", 4, "ngIf"], ["class", "overflow-x-auto", 4, "ngIf"], [1, "btn-premium", "flex", "items-center", "gap-2", 3, "click", "disabled"], [1, "text-xl"], [1, "mb-8", "p-4", "bg-emerald-50", "border-l-4", "border-emerald-500", "text-emerald-700", "rounded-r-2xl", "text-sm", "font-medium", "animate-pulse"], [1, "mb-8", "p-4", "bg-rose-50", "border-l-4", "border-rose-500", "text-rose-700", "rounded-r-2xl", "text-sm", "font-medium", "animate-pulse"], ["id", "feature-form", 1, "form-card"], [1, "flex", "items-center", "justify-between", "mb-8", "pb-4", "border-bottom", "border-slate-100"], [1, "text-2xl", "font-black", "text-slate-900"], [1, "text-slate-300", "hover:text-slate-600", "font-black", "text-2xl", "transition-all", 3, "click"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-8", "mb-8"], [1, "input-group"], ["type", "text", "placeholder", "ACCESS_DIRECTORY", 1, "premium-input", "uppercase", "font-mono", 3, "ngModelChange", "input", "ngModel", "disabled"], ["class", "text-[10px] font-bold text-slate-400 mt-2 uppercase tracking-tighter", 4, "ngIf"], ["class", "text-[10px] font-bold text-rose-500 mt-2 uppercase tracking-tighter", 4, "ngIf"], ["type", "text", "placeholder", "Member Directory Access", 1, "premium-input", 3, "ngModelChange", "ngModel", "disabled"], [1, "md:col-span-2"], [1, "block", "text-[11px]", "font-black", "uppercase", "text-slate-400", "mb-2", "tracking-widest"], ["rows", "3", "placeholder", "Detailed explanation...", 1, "premium-input", 3, "ngModelChange", "ngModel", "disabled"], [1, "premium-input", 3, "ngModelChange", "ngModel", "disabled"], [3, "value", 4, "ngFor", "ngForOf"], [3, "ngValue"], [1, "flex", "justify-end", "gap-3", "pt-6", "border-t", "border-slate-100"], [1, "px-8", "py-3", "rounded-2xl", "border-2", "border-slate-100", "text-slate-400", "font-black", "text-xs", "hover:bg-slate-50", "transition-all", "uppercase", "tracking-widest", "font-mono", 3, "click", "disabled"], [1, "btn-premium", "px-10", "py-3", "font-mono", "font-black", "uppercase", "tracking-widest", 3, "click", "disabled"], [1, "text-[10px]", "font-bold", "text-slate-400", "mt-2", "uppercase", "tracking-tighter"], [1, "text-[10px]", "font-bold", "text-rose-500", "mt-2", "uppercase", "tracking-tighter"], [3, "value"], [1, "p-40", "text-center", "flex", "flex-col", "items-center", "justify-center", "gap-4"], [1, "h-10", "w-10", "border-4", "border-indigo-100", "border-t-indigo-600", "rounded-full", "animate-spin"], [1, "text-[10px]", "font-black", "text-slate-300", "uppercase", "tracking-widest"], [1, "p-40", "text-center"], [1, "text-6xl", "mb-4", "grayscale", "opacity-20"], [1, "text-xs", "font-black", "text-slate-300", "uppercase", "tracking-widest"], [1, "overflow-x-auto"], [1, "w-full"], [1, "bg-slate-50/50"], ["class", "text-right", 4, "ngIf"], [1, "divide-y", "divide-slate-50"], ["class", "hover:bg-slate-50/50 transition-colors", 4, "ngFor", "ngForOf"], [1, "text-right"], [1, "hover:bg-slate-50/50", "transition-colors"], [1, "code-badge", "uppercase", "font-bold"], [1, "font-black", "text-slate-800", "leading-tight"], [1, "text-[10px]", "text-slate-400", "font-bold", "uppercase", "tracking-tight", "mt-1"], [1, "text-xs", "text-slate-500", "font-medium", "max-w-sm", "line-clamp-2", 3, "title"], [1, "cat-pill", "bg-slate-100", "text-slate-500", "font-black"], [1, "text-[10px]", "font-black", "uppercase"], [1, "flex", "items-center", "gap-2"], [1, "text-xs", "font-black", "text-slate-900"], [1, "text-[10px]", "text-slate-400", "font-bold", "uppercase"], [1, "flex", "items-center", "justify-end", "gap-3"], [1, "text-[10px]", "font-black", "text-indigo-600", "hover:text-indigo-800", "transition-all", "uppercase", "tracking-widest", 3, "click"], [1, "text-[10px]", "font-black", "text-rose-500", "hover:text-rose-700", "transition-all", "uppercase", "tracking-widest", 3, "click"]], template: function PlanFeatureManagementComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "div", 7)(18, "div", 8)(19, "p");
        \u0275\u0275text(20, "Active Privileges");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(21, "h3", 11);
        \u0275\u0275text(22);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(23, "div", 12);
        \u0275\u0275text(24, "\u{1F4E1}");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(25, "div", 13)(26, "div", 8)(27, "p");
        \u0275\u0275text(28, "Suspended");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(29, "h3", 14);
        \u0275\u0275text(30);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(31, "div", 15);
        \u0275\u0275text(32, "\u{1F507}");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(33, PlanFeatureManagementComponent_div_33_Template, 2, 1, "div", 16)(34, PlanFeatureManagementComponent_div_34_Template, 2, 1, "div", 17)(35, PlanFeatureManagementComponent_div_35_Template, 39, 19, "div", 18);
        \u0275\u0275elementStart(36, "nav", 19)(37, "button", 20);
        \u0275\u0275listener("click", function PlanFeatureManagementComponent_Template_button_click_37_listener() {
          return ctx.onTabChange("ALL");
        });
        \u0275\u0275text(38, "All Collections");
        \u0275\u0275elementEnd();
        \u0275\u0275template(39, PlanFeatureManagementComponent_button_39_Template, 2, 3, "button", 21);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(40, "div", 22);
        \u0275\u0275template(41, PlanFeatureManagementComponent_div_41_Template, 4, 0, "div", 23)(42, PlanFeatureManagementComponent_div_42_Template, 5, 0, "div", 24)(43, PlanFeatureManagementComponent_div_43_Template, 19, 2, "div", 25);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
        ...
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.isLoading && ctx.filteredFeatures.length === 0);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.isLoading && ctx.filteredFeatures.length > 0);
      }
...
function AdminDashboardComponent_div_85_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminDashboardComponent_div_86_app_member_management_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-member-management", 61);
    \u0275\u0275listener("openDetail", function AdminDashboardComponent_div_86_app_member_management_1_Template_app_member_management_openDetail_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openMemberDetail($event));
    })("openApprove", function AdminDashboardComponent_div_86_app_member_management_1_Template_app_member_management_openApprove_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openApproveMember($event));
    })("openReject", function AdminDashboardComponent_div_86_app_member_management_1_Template_app_member_management_openReject_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminDashboardComponent_div_86_app_event_management_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-event-management", 62);
    \u0275\u0275listener("openDetail", function AdminDashboardComponent_div_86_app_event_management_2_Template_app_event_management_openDetail_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openEventDetail($event));
    })("openEdit", function AdminDashboardComponent_div_86_app_event_management_2_Template_app_event_management_openEdit_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onEditEvent($event));
    })("openCreate", function AdminDashboardComponent_div_86_app_event_management_2_Template_app_event_management_openCreate_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminDashboardComponent_div_86_app_job_management_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-job-management", 63);
    \u0275\u0275listener("openDetail", function AdminDashboardComponent_div_86_app_job_management_3_Template_app_job_management_openDetail_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openJobDetail($event));
    })("openEdit", function AdminDashboardComponent_div_86_app_job_management_3_Template_app_job_management_openEdit_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminDashboardComponent_div_86_app_membership_plan_management_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-membership-plan-management");
  }
}
function AdminDashboardComponent_div_86_app_plan_feature_management_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-plan-feature-management");
  }
}
function AdminDashboardComponent_div_86_div_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 68)(8, "button", 69);
    \u0275\u0275listener("click", function AdminDashboardComponent_div_86_div_6_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function AdminDashboardComponent_div_86_div_6_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onCreateEvent());
    });
...
function AdminDashboardComponent_div_86_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AdminDashboardComponent_div_86_app_member_management_1_Template, 1, 0, "app-member-management", 57)(2, AdminDashboardComponent_div_86_app_event_management_2_Template, 1, 0, "app-event-management", 58)(3, AdminDashboardComponent_div_86_app_job_management_3_Template, 1, 0, "app-job-management", 59)(4, AdminDashboardComponent_div_86_app_membership_plan_management_4_Template, 1, 0, "app-membership-plan-management", 42)(5, AdminDashboardComponent_div_86_app_plan_feature_management_5_Template, 1, 0, "app-plan-feature-management", 42)(6, AdminDashboardComponent_div_86_div_6_Template, 12, 0, "div", 60);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminDashboardComponent_div_87_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminDashboardComponent_div_87_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 86);
    \u0275\u0275listener("click", function AdminDashboardComponent_div_87_div_12_Template_div_click_0_listener() {
      const n_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onNotificationClick(n_r8));
    });
    \u0275\u0275elementStart(1, "div", 87)(2, "div", 88);
    \u0275\u0275element(3, "div");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 89)(5, "div", 90)(6, "p", 91);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "span", 92);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "p", 93);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", n_r8.read ? "bg-white border-slate-100" : "bg-indigo-50/50 border-indigo-100");
    \u0275\u0275advance(3);
    \u0275\u0275classMap(n_r8.read ? "bg-slate-200" : "unread-dot");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(n_r8.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(n_r8.category);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(n_r8.message);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(14, 7, n_r8.createdAt, "MMM d, h:mm a"));
  }
}
function AdminDashboardComponent_div_87_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminDashboardComponent_div_87_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeNotifications());
    });
    \u0275\u0275elementStart(1, "div", 72);
    \u0275\u0275listener("click", function AdminDashboardComponent_div_87_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r6);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 73)(3, "div", 74)(4, "h3", 75);
    \u0275\u0275text(5, "System Updates");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 76);
    \u0275\u0275listener("click", function AdminDashboardComponent_div_87_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeNotifications());
    });
    ...
    \u0275\u0275template(11, AdminDashboardComponent_div_87_div_11_Template, 5, 0, "div", 78)(12, AdminDashboardComponent_div_87_div_12_Template, 15, 10, "div", 79);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 80)(14, "button", 81);
    \u0275\u0275listener("click", function AdminDashboardComponent_div_87_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AdminDashboardComponent_div_87_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
...
var AdminDashboardComponent = class _AdminDashboardComponent {
  constructor(apiService, authService, confirmService) {
    this.apiService = apiService;
    this.authService = authService;
    this.confirmService = confirmService;
  ...
  navigateFromNotificationLink(link) {
    ...
    if (viewParam) {
      const supported = ["MEMBER_MANAGEMENT", "EVENT_MANAGEMENT", "POST_MANAGEMENT", "PLAN_MANAGEMENT", "FEATURE_MANAGEMENT", null];
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminDashboardComponent, selectors: [["app-admin-dashboard"]], outputs: { navigate: "navigate" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 95, vars: 39, consts: [[1, "admin-layout"], [1, "max-w-8xl", "mx-auto", "px-6", "py-10"], [1, "grid", "grid-cols-1", "lg:grid-cols-12", "gap-8", "items-start"], [1, "lg:col-span-4", "space-y-6"], [1, "glass-card", "rounded-3xl", "p-8", "reveal-up"], [1, "flex", "items-start", "justify-between"], [1, "flex", "items-center", "gap-5"], [1, "relative"], [1, "h-20", "w-20", "rounded-2xl", "profile-avatar", "overflow-hidden"], [1, "bg-white", "w-full", "h-full", "p-0.5", "rounded-[14px]", "overflow-hidden"], ["class", "w-full h-full object-cover rounded-[13px]", 3, "src", "alt", 4, "ngIf"], ["class", "w-full h-full flex items-center justify-center bg-slate-50 text-3xl", 4, "ngIf"], [1, "absolute", "-bottom-1", "-right-1", "h-5", "w-5", "bg-emerald-500", "border-4", "border-white", "rounded-full"], [1, "admin-badge", "text-[10px]", "px-2", "py-0.5", "rounded-lg", "mb-2", "inline-block"], [1, "text-xl", "font-black", "text-slate-900", "tracking-tight"], [1, "text-sm", "font-medium", "text-slate-400"], [1, "relative", "p-3", "rounded-2xl", "bg-slate-50", "text-slate-400", "hover:text-indigo-600", "hover:bg-indigo-50", "transition-all", "border", "border-slate-100", "group", 3, "click"], ["width", "24", "height", "24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "viewBox", "0 0 24 24", 1, "group-hover:rotate-12", "transition-transform"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"], ["class", "absolute top-2 right-2 h-4 min-w-[16px] px-1 bg-rose-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center border-2 border-white", 4, "ngIf"], [1, "glass-card", "rounded-3xl", "p-8", "reveal-up", 2, "animation-delay", "0.1s"], [1, "text-xs", "font-black", "text-slate-400", "uppercase", "tracking-widest", "mb-6"], [1, "grid", "grid-cols-2", "gap-4"], [1, "p-4", "bg-blue-50/50", "rounded-2xl", "border", "border-blue-100/50", "stat-card", "text-blue-600"], [1, "text-[10px]", "font-bold", "uppercase", "tracking-wider", "mb-1", "opacity-70"], [1, "text-2xl", "font-black"], [1, "p-4", "bg-indigo-50/50", "rounded-2xl", "border", "border-indigo-100/50", "stat-card", "text-indigo-600"], [1, "p-4", "bg-emerald-50/50", "rounded-2xl", "border", "border-emerald-100/50", "stat-card", "text-emerald-600"], [1, "p-4", "bg-rose-50/50", "rounded-2xl", "border", "border-rose-100/50", "stat-card", "text-rose-600"], [1, "p-6", "bg-slate-900", "rounded-3xl", "text-white", "shadow-2xl", "reveal-up", 2, "animation-delay", "0.2s"], [1, "flex", "items-center", "gap-3", "mb-3"], [1, "h-8", "w-8", "rounded-lg", "bg-white/10", "flex", "items-center", "justify-center"], [1, "text-sm", "font-bold"], [1, "text-xs", "text-slate-400", "leading-relaxed"], [1, "lg:col-span-8", "space-y-8"], [1, "glass-card", "rounded-[32px]", "p-2", "reveal-up", 2, "animation-delay", "0.3s"], [1, "grid", "grid-cols-2", "md:grid-cols-5", "gap-2"], [1, "nav-item", "rounded-3xl", "p-4", "transition-all", 3, "click"], [1, "icon-box"], [1, "text-[10px]", "font-black", "uppercase", "text-slate-500", "tracking-tight"], [1, "glass-card", "rounded-[40px]", "p-8", "min-h-[500px]", "reveal-up", 2, "animation-delay", "0.4s"], ["class", "flex flex-col items-center justify-center py-24 gap-4", 4, "ngIf"], [4, "ngIf"], ["class", "fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-end p-4 md:p-10", 3, "click", 4, "ngIf"], [3, "close", "saved", "isModal", "show", "editEvent", "saveEvent"], [3, "close", "approve", "reject", "show", "application", "showActions"], ["mode", "APPROVE", 3, "close", "confirm", "show", "application"], ["mode", "REJECT", 3, "close", "confirm", "show", "application"], [3, "close", "show", "event"], [3, "close", "show", "jobPosting"], [3, "close", "saved", "show", "editJob"], [1, "w-full", "h-full", "object-cover", "rounded-[13px]", 3, "src", "alt"], [1, "w-full", "h-full", "flex", "items-center", "justify-center", "bg-slate-50", "text-3xl"], [1, "absolute", "top-2", "right-2", "h-4", "min-w-[16px]", "px-1", "bg-rose-500", "text-white", "text-[10px]", "font-bold", "rounded-full", "flex", "items-center", "justify-center", "border-2", "border-white"], [1, "flex", "flex-col", "items-center", "justify-center", "py-24", "gap-4"], [1, "h-12", "w-12", "border-4", "border-indigo-100", "border-t-indigo-600", "rounded-full", "animate-spin"], [1, "text-sm", "font-bold", "text-slate-400", "uppercase", "tracking-widest"], [3, "openDetail", "openApprove", "openReject", 4, "ngIf"], [3, "openDetail", "openEdit", "openCreate", 4, "ngIf"], [3, "openDetail", "openEdit", 4, "ngIf"], ["class", "flex flex-col items-center justify-center py-20 text-center", 4, "ngIf"], [3, "openDetail", "openApprove", "openReject"], [3, "openDetail", "openEdit", "openCreate"], [3, "openDetail", "openEdit"], [1, "flex", "flex-col", "items-center", "justify-center", "py-20", "text-center"], [1, "h-32", "w-32", "bg-indigo-50", "rounded-full", "flex", "items-center", "justify-center", "text-5xl", "mb-8", "animate-pulse"], [1, "text-3xl", "font-black", "text-slate-900", "mb-4", "tracking-tighter"], [1, "text-slate-500", "max-w-sm", "mx-auto", "font-medium", "leading-relaxed", "mb-10"], [1, "flex", "gap-3"], [1, "px-6", "py-3", "bg-white", "border", "border-slate-200", "rounded-2xl", "text-sm", "font-bold", "hover:bg-slate-50", "transition-colors", 3, "click"], [1, "px-6", "py-3", "btn-premium", "rounded-2xl", "text-sm", "font-bold", 3, "click"], [1, "fixed", "inset-0", "bg-slate-900/60", "backdrop-blur-sm", "z-[100]", "flex", "items-center", "justify-end", "p-4", "md:p-10", 3, "click"], [1, "bg-white", "w-full", "max-w-lg", "h-full", "rounded-[40px]", "shadow-2xl", "overflow-hidden", "flex", "flex-col", "reveal-up", 3, "click"], [1, "p-8", "border-b", "border-slate-100"], [1, "flex", "items-center", "justify-between", "mb-2"], [1, "text-2xl", "font-black", "text-slate-900", "tracking-tighter"], [1, "h-10", "w-10", "flex", "items-center", "justify-center", "bg-slate-50", "rounded-full", "hover:bg-slate-100", "transition-colors", "text-slate-400", 3, "click"], [1, "flex-1", "overflow-y-auto", "p-6", "space-y-3"], ["class", "flex flex-col items-center justify-center h-full opacity-30 grayscale", 4, "ngIf"], ["class", "p-5 rounded-3xl border transition-all cursor-pointer notif-item", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], [1, "p-8", "border-t", "border-slate-100", "bg-slate-50/50", "flex", "gap-4"], [1, "flex-1", "px-4", "py-3", "bg-white", "border", "border-slate-200", "rounded-2xl", "text-xs", "font-black", "uppercase", "tracking-widest", "text-slate-600", "hover:bg-white", "hover:border-indigo-200", "transition-all", 3, "click"], [1, "px-4", "py-3", "text-rose-500", "text-xs", "font-black", "uppercase", "tracking-widest", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "h-full", "opacity-30", "grayscale"], [1, "text-6xl", "mb-4"], [1, "font-bold", "uppercase", "tracking-widest", "text-xs"], [1, "p-5", "rounded-3xl", "border", "transition-all", "cursor-pointer", "notif-item", 3, "click", "ngClass"], [1, "flex", "gap-4"], [1, "mt-1"], [1, "flex-1"], [1, "flex", "items-center", "gap-2", "mb-1"], [1, "text-sm", "font-black", "text-slate-900"], [1, "text-[9px]", "font-black", "uppercase", "px-1.5", "py-0.5", "bg-white", "border", "border-slate-100", "rounded", "text-slate-400"], [1, "text-sm", "text-slate-500", "font-medium", "leading-snug"], [1, "text-[10px]", "text-slate-400", "mt-3", "font-bold", "uppercase", "tracking-tight"]], template: function AdminDashboardComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(23, AdminDashboardComponent_span_23_Template, 2, 1, "span", 19);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(24, "div", 20)(25, "h3", 21);
        \u0275\u0275text(26, "Real-time Statistics");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(27, "div", 22)(28, "div", 23)(29, "p", 24);
        \u0275\u0275text(30, "Pending");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(31, "p", 25);
        \u0275\u0275text(32);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(33, "div", 26)(34, "p", 24);
        \u0275\u0275text(35, "Members");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(36, "p", 25);
        \u0275\u0275text(37);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(38, "div", 27)(39, "p", 24);
        \u0275\u0275text(40, "Events");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(41, "p", 25);
        \u0275\u0275text(42);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(43, "div", 28)(44, "p", 24);
        \u0275\u0275text(45, "Postings");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(46, "p", 25);
        \u0275\u0275text(47);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(48, "div", 29)(49, "div", 30)(50, "span", 31);
        \u0275\u0275text(51, "\u{1F4A1}");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(56, "main", 34)(57, "header", 35)(58, "div", 36)(59, "button", 37);
        ...
        \u0275\u0275text(83, "Features");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(84, "section", 40);
        \u0275\u0275template(85, AdminDashboardComponent_div_85_Template, 4, 0, "div", 41)(86, AdminDashboardComponent_div_86_Template, 7, 6, "div", 42);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(87, AdminDashboardComponent_div_87_Template, 18, 2, "div", 43);
        \u0275\u0275elementStart(88, "app-event-create", 44);
        \u0275\u0275listener("close", function AdminDashboardComponent_Template_app_event_create_close_88_listener() {
          return ctx.closeGlobalModals();
        })("saved", function AdminDashboardComponent_Template_app_event_create_saved_88_listener() {
          return ctx.onEventSaved();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(89, "app-application-detail-modal", 45);
        \u0275\u0275listener("close", function AdminDashboardComponent_Template_app_application_detail_modal_close_89_listener() {
          return ctx.closeGlobalModals();
        })("approve", function AdminDashboardComponent_Template_app_application_detail_modal_approve_89_listener($event) {
          return ctx.openApproveMember($event);
        })("reject", function AdminDashboardComponent_Template_app_application_detail_modal_reject_89_listener($event) {
          return ctx.openRejectMember($event);
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(90, "app-approve-reject-modal", 46);
        \u0275\u0275listener("close", function AdminDashboardComponent_Template_app_approve_reject_modal_close_90_listener() {
          return ctx.closeGlobalModals();
        })("confirm", function AdminDashboardComponent_Template_app_approve_reject_modal_confirm_90_listener() {
          return ctx.closeGlobalModals();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(91, "app-approve-reject-modal", 47);
        \u0275\u0275listener("close", function AdminDashboardComponent_Template_app_approve_reject_modal_close_91_listener() {
          return ctx.closeGlobalModals();
        })("confirm", function AdminDashboardComponent_Template_app_approve_reject_modal_confirm_91_listener() {
          return ctx.closeGlobalModals();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(92, "app-event-detail-modal", 48);
        \u0275\u0275listener("close", function AdminDashboardComponent_Template_app_event_detail_modal_close_92_listener() {
          return ctx.closeGlobalModals();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(93, "app-job-detail-modal", 49);
        \u0275\u0275listener("close", function AdminDashboardComponent_Template_app_job_detail_modal_close_93_listener() {
          return ctx.closeGlobalModals();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(94, "app-job-post-modal", 50);
        \u0275\u0275listener("close", function AdminDashboardComponent_Template_app_job_post_modal_close_94_listener() {
          return ctx.closeGlobalModals();
        })("saved", function AdminDashboardComponent_Template_app_job_post_modal_saved_94_listener() {
          return ctx.onEventSaved();
        });
        \u0275\u0275elementEnd()();
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminDashboardComponent, { className: "AdminDashboardComponent", filePath: "src\\app\\pages\\admin-dashboard\\admin-dashboard.component.ts", lineNumber: 47 });
})();
export {
  AdminDashboardComponent
};
//# sourceMappingURL=chunk-MUX3D7GQ.js.map
