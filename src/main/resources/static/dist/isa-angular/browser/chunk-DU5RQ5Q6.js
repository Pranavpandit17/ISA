...
function EventCreateComponent_div_0_div_15_div_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 73)(1, "div", 25)(2, "label", 26);
    \u0275\u0275text(3, "Member price");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "input", 74);
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_15_div_32_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 25)(6, "label", 26);
    \u0275\u0275text(7, "Non-member price");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "input", 74);
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_15_div_32_Template_input_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function EventCreateComponent_div_0_div_15_div_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 75)(1, "button", 76);
    \u0275\u0275listener("click", function EventCreateComponent_div_0_div_15_div_39_Template_button_click_1_listener() {
    ...
    \u0275\u0275text(2, "Remove");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 77)(4, "input", 78);
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_15_div_39_Template_input_ngModelChange_4_listener($event) {
      const t_r14 = \u0275\u0275restoreView(_r12).$implicit;
      \u0275\u0275twoWayBindingSet(t_r14.name, $event) || (t_r14.name = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "select", 79);
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_15_div_39_Template_select_ngModelChange_5_listener($event) {
      const t_r14 = \u0275\u0275restoreView(_r12).$implicit;
    ...
    \u0275\u0275text(11, "Early bird");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "option", 83);
    \u0275\u0275text(13, "VIP");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "input", 84);
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_15_div_39_Template_input_ngModelChange_14_listener($event) {
      const t_r14 = \u0275\u0275restoreView(_r12).$implicit;
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_15_div_39_Template_input_ngModelChange_15_listener($event) {
      const t_r14 = \u0275\u0275restoreView(_r12).$implicit;
...
function EventCreateComponent_div_0_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(32, EventCreateComponent_div_0_div_15_div_32_Template, 9, 2, "div", 67);
    \u0275\u0275elementStart(33, "div", 68)(34, "h4", 69);
    \u0275\u0275text(35, "Ticket types");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "button", 70);
    \u0275\u0275listener("click", function EventCreateComponent_div_0_div_15_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.addTicketType());
    });
    \u0275\u0275text(37, "+ Add ticket type");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 71);
    \u0275\u0275template(39, EventCreateComponent_div_0_div_15_div_39_Template, 16, 4, "div", 72);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function EventCreateComponent_div_0_div_16_div_9_div_24_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", s_r18.avatarPreviewUrl || s_r18.avatarUrl, \u0275\u0275sanitizeUrl);
  }
}
function EventCreateComponent_div_0_div_16_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function EventCreateComponent_div_0_div_16_div_9_Template_button_click_1_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.removeSpeaker(i_r17));
    });
    \u0275\u0275text(2, "Remove");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_9_Template_input_ngModelChange_11_listener($event) {
      const s_r18 = \u0275\u0275restoreView(_r16).$implicit;
      \u0275\u0275twoWayBindingSet(s_r18.name, $event) || (s_r18.name = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_9_Template_input_ngModelChange_15_listener($event) {
      const s_r18 = \u0275\u0275restoreView(_r16).$implicit;
      \u0275\u0275twoWayBindingSet(s_r18.title, $event) || (s_r18.title = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 25)(17, "label", 26);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_9_Template_input_ngModelChange_19_listener($event) {
      const s_r18 = \u0275\u0275restoreView(_r16).$implicit;
      \u0275\u0275twoWayBindingSet(s_r18.company, $event) || (s_r18.company = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 37)(21, "label", 26);
    ...
    \u0275\u0275listener("change", function EventCreateComponent_div_0_div_16_div_9_Template_input_change_23_listener($event) {
      const i_r17 = \u0275\u0275restoreView(_r16).index;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.onSpeakerAvatarChange(i_r17, $event));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_9_Template_textarea_ngModelChange_28_listener($event) {
      const s_r18 = \u0275\u0275restoreView(_r16).$implicit;
      \u0275\u0275twoWayBindingSet(s_r18.bio, $event) || (s_r18.bio = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_9_Template_input_ngModelChange_32_listener($event) {
      const s_r18 = \u0275\u0275restoreView(_r16).$implicit;
      \u0275\u0275twoWayBindingSet(s_r18.linkedinUrl, $event) || (s_r18.linkedinUrl = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_9_Template_input_ngModelChange_36_listener($event) {
      const s_r18 = \u0275\u0275restoreView(_r16).$implicit;
      \u0275\u0275twoWayBindingSet(s_r18.twitterUrl, $event) || (s_r18.twitterUrl = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_9_Template_input_ngModelChange_40_listener($event) {
      const s_r18 = \u0275\u0275restoreView(_r16).$implicit;
      \u0275\u0275twoWayBindingSet(s_r18.websiteUrl, $event) || (s_r18.websiteUrl = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("Speaker ", i_r17 + 1, "");
    \u0275\u0275advance(7);
    \u0275\u0275twoWayProperty("ngModel", s_r18.name);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", s_r18.title);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", s_r18.company);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", s_r18.avatarPreviewUrl || s_r18.avatarUrl);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", s_r18.bio);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", s_r18.linkedinUrl);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", s_r18.twitterUrl);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", s_r18.websiteUrl);
  }
}
function EventCreateComponent_div_0_div_16_div_16_option_38_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngValue", opt_r22.index);
    \u0275\u0275advance();
...
function EventCreateComponent_div_0_div_16_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function EventCreateComponent_div_0_div_16_div_16_Template_button_click_1_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.removeSchedule(i_r20));
    });
    \u0275\u0275text(2, "Remove");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 89);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_16_Template_input_ngModelChange_11_listener($event) {
      ...
      \u0275\u0275twoWayBindingSet(item_r21.startTime, $event) || (item_r21.startTime = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 25)(13, "label", 26);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_16_Template_input_ngModelChange_17_listener($event) {
      const item_r21 = \u0275\u0275restoreView(_r19).$implicit;
      \u0275\u0275twoWayBindingSet(item_r21.endTime, $event) || (item_r21.endTime = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_16_Template_input_ngModelChange_23_listener($event) {
      const item_r21 = \u0275\u0275restoreView(_r19).$implicit;
      \u0275\u0275twoWayBindingSet(item_r21.title, $event) || (item_r21.title = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_16_Template_textarea_ngModelChange_27_listener($event) {
      const item_r21 = \u0275\u0275restoreView(_r19).$implicit;
      \u0275\u0275twoWayBindingSet(item_r21.description, $event) || (item_r21.description = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_16_Template_input_ngModelChange_31_listener($event) {
      const item_r21 = \u0275\u0275restoreView(_r19).$implicit;
      \u0275\u0275twoWayBindingSet(item_r21.location, $event) || (item_r21.location = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventCreateComponent_div_0_div_16_div_16_Template_select_ngModelChange_35_listener($event) {
      const item_r21 = \u0275\u0275restoreView(_r19).$implicit;
      \u0275\u0275twoWayBindingSet(item_r21.speakerIndex, $event) || (item_r21.speakerIndex = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(36, "option", 101);
    \u0275\u0275text(37, "No speaker");
    \u0275\u0275elementEnd();
    \u0275\u0275template(38, EventCreateComponent_div_0_div_16_div_16_option_38_Template, 2, 2, "option", 102);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("Schedule item ", i_r20 + 1, "");
    \u0275\u0275advance(7);
    \u0275\u0275twoWayProperty("ngModel", item_r21.startTime);
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", item_r21.endTime);
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", item_r21.title);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", item_r21.description);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", item_r21.location);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", item_r21.speakerIndex);
    \u0275\u0275advance();
...
function EventCreateComponent_div_0_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 68)(4, "h4", 69);
    \u0275\u0275text(5, "Speakers");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(9, EventCreateComponent_div_0_div_16_div_9_Template, 41, 9, "div", 86);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 68)(11, "h4", 69);
    ...
    \u0275\u0275template(16, EventCreateComponent_div_0_div_16_div_16_Template, 39, 9, "div", 86);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function EventCreateComponent_div_0_div_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 104)(1, "button", 106);
...
function EventCreateComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(12, EventCreateComponent_div_0_div_12_Template, 47, 5, "div", 11)(13, EventCreateComponent_div_0_div_13_Template, 30, 8, "div", 11)(14, EventCreateComponent_div_0_div_14_Template, 51, 6, "div", 11)(15, EventCreateComponent_div_0_div_15_Template, 40, 6, "div", 11)(16, EventCreateComponent_div_0_div_16_Template, 17, 2, "div", 11);
    \u0275\u0275elementEnd();
...
var EventCreateComponent = class _EventCreateComponent {
  ...
  buildEventJson() {
    ...
    const uniqueTicketTypes = /* @__PURE__ */ new Map();
    for (const t of this.eventData.ticketTypes || []) {
    ...
    const ticketTypes = Array.from(uniqueTicketTypes.values()).filter((t) => t.name && String(t.name).trim()).map((t) => ({
...
//# sourceMappingURL=chunk-DU5RQ5Q6.js.map
