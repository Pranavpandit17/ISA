...
function EventDetailComponent_div_4_ng_container_42_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, " No ticket tier is available for your current membership. Upgrade your plan or contact support if you believe this is an error. ");
    \u0275\u0275elementEnd();
  }
}
function EventDetailComponent_div_4_ng_container_42_div_2_button_4_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 81)(1, "span", 53);
...
function EventDetailComponent_div_4_ng_container_42_div_2_button_4_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 81)(1, "span", 53);
    \u0275\u0275text(2, "Ends On");
    \u0275\u0275elementEnd();
...
function EventDetailComponent_div_4_ng_container_42_div_2_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 78);
    \u0275\u0275listener("click", function EventDetailComponent_div_4_ng_container_42_div_2_button_4_Template_button_click_0_listener() {
    ...
    \u0275\u0275pipe(11, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, EventDetailComponent_div_4_ng_container_42_div_2_button_4_div_12_Template, 5, 1, "div", 80)(13, EventDetailComponent_div_4_ng_container_42_div_2_button_4_div_13_Template, 6, 4, "div", 80);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function EventDetailComponent_div_4_ng_container_42_div_2_div_5_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_div_4_ng_container_42_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44)(1, "label", 45);
    \u0275\u0275text(2, "Your ticket options");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 46);
    \u0275\u0275template(4, EventDetailComponent_div_4_ng_container_42_div_2_button_4_Template, 14, 19, "button", 76);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, EventDetailComponent_div_4_ng_container_42_div_2_div_5_Template, 4, 1, "div", 77);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngForOf", ctx_r0.getVisibleTicketTypes());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getSelectedTicketReason());
  }
}
function EventDetailComponent_div_4_ng_container_42_span_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 84);
  }
}
function EventDetailComponent_div_4_ng_container_42_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, EventDetailComponent_div_4_ng_container_42_div_1_Template, 2, 0, "div", 59)(2, EventDetailComponent_div_4_ng_container_42_div_2_Template, 6, 2, "div", 29);
    \u0275\u0275elementStart(3, "div", 60)(4, "div", 61)(5, "label", 62);
    \u0275\u0275text(6, "Unit Investment (Base)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 63);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 64)(10, "label", 65);
    \u0275\u0275text(11, "Magnitude (Quantity)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 66)(13, "button", 67);
    \u0275\u0275listener("click", function EventDetailComponent_div_4_ng_container_42_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function EventDetailComponent_div_4_ng_container_42_Template_input_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r0.quantity, $event) || (ctx_r0.quantity = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function EventDetailComponent_div_4_ng_container_42_Template_input_change_15_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function EventDetailComponent_div_4_ng_container_42_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(17, "+");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(18, "div", 69)(19, "div", 70)(20, "span", 71);
    \u0275\u0275text(21, "Committing Value");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "span", 72);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "button", 73);
    \u0275\u0275listener("click", function EventDetailComponent_div_4_ng_container_42_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onRegister());
    });
    \u0275\u0275template(25, EventDetailComponent_div_4_ng_container_42_span_25_Template, 1, 0, "span", 74);
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getTicketTypes().length && !ctx_r0.getVisibleTicketTypes().length);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getVisibleTicketTypes().length);
    \u0275\u0275advance(6);
...
function EventDetailComponent_div_4_div_44_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, EventDetailComponent_div_4_div_44_ng_container_4_div_1_Template, 8, 3, "div", 89);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function EventDetailComponent_div_4_div_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 85)(1, "h3", 86);
    \u0275\u0275text(2, "Voice & Authority");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 87);
    \u0275\u0275template(4, EventDetailComponent_div_4_div_44_ng_container_4_Template, 2, 1, "ng-container", 88)(5, EventDetailComponent_div_4_div_44_ng_template_5_Template, 8, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function EventDetailComponent_div_4_div_45_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 98)(4, "p", 20);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
...
function EventDetailComponent_div_4_div_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 87);
    \u0275\u0275template(4, EventDetailComponent_div_4_div_45_div_4_Template, 8, 3, "div", 95);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function EventDetailComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(39);
    \u0275\u0275elementEnd();
    \u0275\u0275template(40, EventDetailComponent_div_4_div_40_Template, 5, 1, "div", 29)(41, EventDetailComponent_div_4_div_41_Template, 8, 3, "div", 30)(42, EventDetailComponent_div_4_ng_container_42_Template, 27, 13, "ng-container", 31);
    \u0275\u0275elementEnd();
...
var EventDetailComponent = class _EventDetailComponent {
  ...
  getSelectedTicketReason() {
    ...
    if (!this.isTicketEligible(ticket)) {
      if (ticket.type === "MEMBER")
        return "This paid member tier requires an active paid membership.";
      if (ticket.type === "FREE_MEMBER")
        return "This tier requires an active membership.";
  ...
  isEventPaid() {
    ...
    const ticket = this.getSelectedTicket();
    if (ticket)
      return Number(ticket.price || 0) > 0;
...
//# sourceMappingURL=chunk-FZYH3EAM.js.map
